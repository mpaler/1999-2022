 ...
 * @ingroup theming
 */
function forum_plus_preprocess_simplenews_newsletter_footer(&$variables) {
  // Alter the unsubscribe link to contain the newsletter name.
  $variables['unsubscribe_text'] = t('Unsubscribe from @name', array('@name' => $variables['category']->name), array('langcode' => $variables['language']));
